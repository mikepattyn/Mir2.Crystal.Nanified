...
public class GameLanguage
{
    ...
    public static void LoadClientLanguage(string languageIniPath)
    {
        ...
        ExpandedStorageExpiresOn = reader.ReadString("Language", "ExpandedStorageExpiresOn", ExpandedStorageExpiresOn);
        ...
        CreatingCharactersDisabled = reader.ReadString("Language", "CreatingCharactersDisabled", CreatingCharactersDisabled);
        ...
        ItemTypeCraftingMaterial = reader.ReadString("Language", "ItemTypeCraftingMaterial", ItemTypeCraftingMaterial);
        ...
        IncorrectPasswordAccountID = reader.ReadString("Language", "IncorrectPasswordAccountID", IncorrectPasswordAccountID);
